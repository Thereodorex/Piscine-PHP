// const baseURL           = 'http://192.168.29.124:8100/rush0000/api/';
const baseURL = 'http://localhost:8100/rush00/api/';
...
if (adminBody && !isAdmin()) location.pathname = 'rush00/index.php';
    ...
    fetch(`${baseURL}loginUser.php`, {
        ...
        .then(res => {
            if (res.error) {
                ...
                window.location.pathname = 'rush00/index.php'
            }
        });
    return false;
}
...
function logout() {
    ...
    cart.clear();
    location.pathname = 'rush00/index.php'
}
...
function addUser() {
    ...
    fetch(`${baseURL}addUser.php`, {
        ...
        .then(res => location.pathname.indexOf('register.html') >= 0 ?
            location.pathname = 'rush00/pages/auth.html' :
            renderUsers());
    return false;
}
...
<div class="left-side">
    ...
    `
    <div class="nav-item">
        <a onclick="location.pathname='rush00/pages/admin.html'">
            Админка
        </a>
    </div>
    ` : ''}
    <div class="nav-item">
        <a onclick="location.pathname = 'rush00/index.php'">
            Главная
        </a>
    </div>
    <div class="nav-item">
        <a  onclick="location.pathname = 'rush00/pages/shop.html'">
            Товары
        </a>
    </div>
</div>
<div class="right-side">
    <div class="nav-item">
        <a class="cart" onclick="location.pathname = 'rush00/pages/cart.html'">
    ...
    `
    <div class="nav-item">
        <a onclick="location.pathname = 'rush00/pages/auth.html'">
            Авторизация
        </a>
    </div>
    `}
        ...
        fetch(`${baseURL}addTransaction.php`, {
            ...
            .then(res => {
                if (res.response.status === 'Ok') {
                    alert('Success!');
                    location.pathname = 'rush00/pages/shop.html';
                } else {
